          ...
          <div className="flex-1 flex flex-col items-center justify-center p-gutter bg-surface">
            <div className="w-full max-w-md">
              ...
              <form className="space-y-md" onSubmit={handleSubmit}>
                ...
                <button onClick={handleGoogleSignup} type="button" className="w-full flex items-center justify-center gap-base py-sm border border-outline-variant rounded-lg hover:bg-surface-container-low transition-colors">
